...
const services: Service[] = [
  {
    ...
    description: 'I build complete web applications that are reliable, easy to maintain, and ready for real users. My stack includes React, Node.js, Express, and MongoDB — from UI to database.',
    bgText: 'FULLSTACK',
    screenType: 1,
  },
  {
    ...
    description: 'I develop frontend interfaces that feel smooth, intuitive, and consistent across all devices. Using React, Tailwind CSS, and responsive design principles for clean, user-friendly layouts.',
    bgText: 'FRONTEND',
    screenType: 2,
  },
  {
    ...
    description: 'I build secure and reliable backend systems that handle data, business logic, and third-party integrations smoothly. Node.js, Express, REST APIs, and MongoDB are my core tools.',
    bgText: 'BACKEND',
    screenType: 3,
  },
  {
    ...
    description: 'I handle smooth deployments and provide ongoing support to keep your application stable and secure. From hosting setup to bug fixes — I ve got you covered after launch.',
    bgText: 'DEVOPS',
    screenType: 4,
  },
]
